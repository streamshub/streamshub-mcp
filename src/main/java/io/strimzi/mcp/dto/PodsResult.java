...
/**
 * Unified structured result for pod queries -- both summary listings and detailed descriptions.
 *
...
public record PodsResult(
    ...
    // --- nested records (moved from PodDescribeResult) ---
     ...
     * @param clusterName the Kafka cluster name
     * @param pods the list of pod information
     * @return a PodsResult with the pod data
     */
    public static PodsResult of(String namespace, String clusterName, List<PodInfo> pods) {
     ...
     * @param namespace the Kubernetes namespace
     * @param clusterName the Kafka cluster name
     * @return an empty PodsResult
     */
    public static PodsResult empty(String namespace, String clusterName) {
        return new PodsResult(
    ...
    /**
     * Creates an error result when pod retrieval fails.
     *
     * @param namespace the Kubernetes namespace
     * @param clusterName the Kafka cluster name
     * @param errorMessage the error description
     * @return an error PodsResult
     */
    public static PodsResult error(String namespace, String clusterName, String errorMessage) {
        return new PodsResult(
            namespace, clusterName, 0, 0, 0,
            null, null, "ERROR", Instant.now(),
     ...
     * @return a not-found PodsResult
     */
    public static PodsResult notFound(String namespace, String podName) {
        return new PodsResult(
