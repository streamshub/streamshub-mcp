...
public final class StrimziConstants {
    ...
    /**
     * Strimzi annotation keys.
     */
    public static final class Annotations {
        /**
         * Annotation used to pause resource reconciliation.
         */
        public static final String PAUSE_RECONCILIATION = "strimzi.io/pause-reconciliation";

        /**
         * Annotation indicating whether a KafkaTopic is managed by Topic Operator.
         */
        public static final String MANAGED = "strimzi.io/managed";

        /**
         * Annotation enabling connector resources on KafkaConnect.
         */
        public static final String USE_CONNECTOR_RESOURCES = "strimzi.io/use-connector-resources";

        /**
         * Annotation for next node IDs allocation.
         */
        public static final String NEXT_NODE_IDS = "strimzi.io/next-node-ids";

        /**
         * Annotation for removing node IDs from pool.
         */
        public static final String REMOVE_NODE_IDS = "strimzi.io/remove-node-ids";

        /**
         * Annotation to skip broker scale-down checks.
         */
        public static final String SKIP_BROKER_SCALEDOWN_CHECK = "strimzi.io/skip-broker-scaledown-check";

        /**
         * Pod-level annotation for tracking pod revision.
         */
        public static final String POD_REVISION = "strimzi.io/revision";

        /**
         * Pod-level annotation for cluster CA cert generation.
         */
        public static final String CLUSTER_CA_CERT_GENERATION = "strimzi.io/cluster-ca-cert-generation";

        /**
         * Pod-level annotation for clients CA cert generation.
         */
        public static final String CLIENTS_CA_CERT_GENERATION = "strimzi.io/clients-ca-cert-generation";

        /**
         * Pod-level annotation for server cert hash.
         */
        public static final String SERVER_CERT_HASH = "strimzi.io/server-cert-hash";

        /**
         * Set of standard Strimzi resource annotations to surface in responses.
         */
        public static final java.util.Set<String> STRIMZI_ANNOTATIONS = java.util.Set.of(
            PAUSE_RECONCILIATION,
            MANAGED,
            USE_CONNECTOR_RESOURCES,
            NEXT_NODE_IDS,
            REMOVE_NODE_IDS,
            SKIP_BROKER_SCALEDOWN_CHECK
        );
