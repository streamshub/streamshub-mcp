...
public record KafkaBridgeMetricsResponse(
     ...
     */
    public static KafkaBridgeMetricsResponse of(final String bridgeName, final String namespace,
        ...
        String msg = String.format("Retrieved %d samples across %d metrics from KafkaBridge '%s'",
            samples.size(), metricCount, bridgeName);
