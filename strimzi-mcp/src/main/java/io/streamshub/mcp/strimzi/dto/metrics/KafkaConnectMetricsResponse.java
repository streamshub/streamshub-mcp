...
public record KafkaConnectMetricsResponse(
     ...
     */
    public static KafkaConnectMetricsResponse of(final String connectName, final String namespace,
        ...
        String msg = String.format("Retrieved %d samples across %d metrics from KafkaConnect '%s'",
            samples.size(), metricCount, connectName);
