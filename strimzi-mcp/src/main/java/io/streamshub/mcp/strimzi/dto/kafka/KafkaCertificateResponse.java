 ...
 * @param clusterCaPolicy        the cluster CA policy
 * @param clientsCaPolicy        the clients CA policy
...
public record KafkaCertificateResponse(
    ...
    @JsonProperty("cluster_ca_policy") CaPolicyInfo clusterCaPolicy,
    @JsonProperty("clients_ca_policy") CaPolicyInfo clientsCaPolicy,
    ...
    /**
     * CA certificate policy configuration and calculated renewal date.
     *
     * @param renewalDays                  configured renewal days before expiry
     * @param validityDays                 validity days
     * @param generateCertificateAuthority whether the CA is generated by Strimzi
     * @param certificateExpirationPolicy  the expiration policy (renew-certificate, etc.)
     * @param calculatedRenewalDate        projected renewal date based on current active certificate
     */
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public record CaPolicyInfo(
        @JsonProperty("renewal_days") Integer renewalDays,
        @JsonProperty("validity_days") Integer validityDays,
        @JsonProperty("generate_certificate_authority") Boolean generateCertificateAuthority,
        @JsonProperty("certificate_expiration_policy") String certificateExpirationPolicy,
        @JsonProperty("calculated_renewal_date") Instant calculatedRenewalDate
    ) {
    }

    /**
     * Creates a successful response with certificate, CA policy, and listener authentication data.
     *
     * @param clusterName            the Kafka cluster name
     * @param namespace              the Kubernetes namespace
     * @param clusterCaPolicy        the cluster CA policy
    ...
    public static KafkaCertificateResponse of(final String clusterName, final String namespace,
                                              final CaPolicyInfo clusterCaPolicy,
                                              final CaPolicyInfo clientsCaPolicy,
