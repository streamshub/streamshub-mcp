...
This guide provides practical examples of using StreamsHub MCP servers with AI assistants to manage and troubleshoot your Kafka infrastructure.
...
- [Strimzi MCP README](../strimzi-mcp/README.md) — Complete tool reference