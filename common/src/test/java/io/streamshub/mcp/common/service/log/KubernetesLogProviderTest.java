...
class KubernetesLogProviderTest {
    ...
    @Inject
    KubernetesLogProvider kubernetesLogProvider;
    ...
    void testFetchLogsBasic() {
        ...
        String result = kubernetesLogProvider.fetchLogs(NAMESPACE, POD_NAME, TAIL_LINES, null, null);
    ...
    void testFetchLogsWithSinceSeconds() {
        ...
        String result = kubernetesLogProvider.fetchLogs(NAMESPACE, POD_NAME, TAIL_LINES, 300, null);
    ...
    void testFetchLogsWithPrevious() {
        ...
        String result = kubernetesLogProvider.fetchLogs(NAMESPACE, POD_NAME, TAIL_LINES, null, true);
    ...
    void testFetchLogsPreviousTakesPrecedenceOverSinceSeconds() {
        ...
        String result = kubernetesLogProvider.fetchLogs(NAMESPACE, POD_NAME, TAIL_LINES, 300, true);
